...
<div class="container">
	<br/>
		<h3 class="text-center">Your newest order</h3>
		<hr>
	<br/>
	...
	<div class="row">
		<div style="float:left;width:800px;margin:auto;border: 3px solid black;border-radius: 12px;padding: 5px;">
			...
			<form action="<%=request.getContextPath()%>/confirmOrder" method="post">
				...
				<div class="form-group">
				<label for="email" name="email">Email: <c:out value='${order.cart.customer.email}' /></label>
				</div>
				...
				<div class="form-group">
				<label for="address" name="address">Status: Wait for staff handle</label>
				</div>
