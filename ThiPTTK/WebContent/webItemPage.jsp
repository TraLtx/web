            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ">
                ...
                <li class="nav-item active">
                  <a class="nav-link" href="<%=request.getContextPath()%>/webItem">Web Item<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
			...
			<table class="table table-bordered">
				...
				<tbody>
					...
					<c:forEach var="bookItem" items="${listBook}">
						...
						<tr>
							<td><c:out value="${bookItem.book.typeID}${bookItem.book.bookID}" /></td>
                    		...
                    		<td><c:out value="${bookItem.book.publishYear}" /></td>
							<td> 
                        		<a href="<%=request.getContextPath()%>/editItem?id=<c:out value='${bookItem.id}' />">Edit</a>  
                        		&nbsp;&nbsp;&nbsp;&nbsp;
                        		<a href="<%=request.getContextPath()%>/storeItem?id=<c:out value='${bookItem.id}' />">Store</a>  
                       		</td>
						</tr>
					</c:forEach>
					<!-- } -->
