...
<body>
      ...
      <div class="header_top">
        <div class="container-fluid">
          <div class="top_nav_container">
            ...
            <form class="search_form" action="<%=request.getContextPath()%>/searchBook" method="post">
  ...
  <div class="container">
      <div class="heading_container heading_center">
        ...
        <h4>Found: <c:out value='${amount}' /> result!</h4>
      </div>
    			...
    			<c:forEach var="bookItem" items="${listBookItem}"> 
		          <div class="box">    
		            <div class="img-box">
		              ...
		              <a href="<%=request.getContextPath()%>/addToCart?id=<c:out value='${bookItem.book.bookID}' />" class="add_cart_btn">
		                <span>
		                  Add To Cart
		                </span>
		              </a>
