...
<div class="box1">
    ...
    <div class="col-md-4">
        <img style="height:500px;" src="resources/images/books/${bookItem.image}" alt="">     
    </div>
    
    <div class="col-md-6">
        <h4>Title: <c:out value='${bookItem.book.title}' /></h4>
        <h5>Author: <c:out value='${bookItem.book.author.name}' /></h5>
        
        <h6>Language: <c:out value='${bookItem.book.language}' /></h6>
        <h6>Number of pages: <c:out value='${bookItem.book.numOfPages}' /></h6>
        <h6>Publish year: <c:out value='${bookItem.book.publishYear}' /></h6>
        <h4>Price: <c:out value='${bookItem.price}' /></h4>
        
        <p>Summary: <c:out value='${bookItem.book.summary}' /></p><br/>
        <div>
    	<a class="button" href="<%=request.getContextPath()%>/addToCart?id=<c:out value='${bookItem.book.bookID}' />">
